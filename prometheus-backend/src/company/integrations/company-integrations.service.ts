  ...
  listProviderCatalog(): ProviderCatalogDTO {
    return {
      platform: [
        ...
        this.platformProvider("openai", "Brain Pro AI gateway", "local", ["OPENAI_BASE_URL", "OPENAI_API_KEY", "OPENAI_MODEL"], this.envStatus(["OPENAI_BASE_URL", "OPENAI_API_KEY"]), "Prometheus Brain Pro can use local LM Studio, Prometheus-managed OpenAI, or a company-owned OpenAI key from Company Setup."),
